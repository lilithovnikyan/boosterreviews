...
export default function Reviews(props) {
    ...
    return (
        <>
            {loading ?
                <div className="reviewLoadingMain">
                    <div className="reviewLoadingProduct">
                        <div className="reviewLoadingProductRightLeft"></div>
                        <div className="reviewLoadingProductInfo">
                            <div className="reviewLoadingProductInfoBlock"></div>
                            <div className="reviewLoadingProductInfoBlock"></div>
                            <div className="reviewLoadingProductInfoBlock"></div>
                            <div className="reviewLoadingProductInfoBlock"></div>
                        </div>
                        ...
                        <div id="posts">
                            <div className="container-fluid br-content-container">
                                {reviewObj.map((itemData, i) => {
                                    ...
                                    return <article key={i} id="post-201"
                                                    className="product post-201 review type-review status-publish has-post-thumbnail hentry review-category-4g-signal-boosters entry">
                                        <div className="row no-gutters product-row">
                                            <div
                                                className="order-1 order-md-1 col-7 col-md-3 col-lg-3 col-xl-3 product-logo py-3">
                                                {bestRated}
                                                <div className="product-number">{i + 1}</div>
                                                <a target="_blank" href={br_url}>
                                                    <img src={thumbnail} loading="lazy"
                                                         alt={`product-picture${i + 1}`}/>
                                                </a>
                                            </div>
                                            <div
                                                className="order-3 order-md-2 col-12 col-md-6 col-lg-6 col-xl-6 product-features-col no-gutters">

                                                <div className="row no-gutters">
                                                    <div className="col-12 visible-desktop">
                                                        <div
                                                            className="row no-gutters text-center rating-price-row price-version">
                                                    ...
                                                    <div
                                                        className="col-12 col-md-6 product-feature-list first-feature-list">
                                                        <div className="metadata">
                                                            <ul className="inner-table-features">
                                                                {br_features_list_col1.map((listItem, j) => {
                                                                    return <li key={j}
                                                                               className={`inner-table-feat ${listItem.br_feature_available ? 'green_img' : 'red_img'}`}>
                                                    ...
                                                    <div className="job-meta table-cta-container visible-mobile">
                                                        <a target="_blank" href={br_url} rel="nofollow"
                                                           className="btn btn-primary btn-green button-score tracking-link visit-link-table">Visit
                                                            site</a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div
                                                className="order-2 order-md-3 col-5 col-md-3 col-lg-3 col-xl-3 product-rating">
                                                ...
                                                <div className="job-meta metascore visible-desktop">
                                                    ...
                                                    <div className="job-meta table-cta-container visible-desktop">
                                                        <a href={br_url} target="_blank" rel="nofollow"
                                                           className="btn btn-primary btn-green button-score tracking-link visit-link-table">Visit
                                                            site</a>
                                                    </div>
                                                </div>
